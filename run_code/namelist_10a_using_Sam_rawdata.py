...
# For retrospective ICs
RT_VARS = {
			'H100':{'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/hgtAll.nc',
					'varname':'gh','level':100,'levname':'isobaricInhPa'},
			'H500':{'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/hgtAll.nc',
					'varname':'gh','level':500,'levname':'isobaricInhPa'},
			'SLP':{'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/surfAll.nc',
					'varname':'msl'},
			'T2m':{'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/surfAll.nc',
					'varname':'t2m'},
			'colIrr':{'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/phy2mAll.nc',
					'varname':'colIrr'},
			}

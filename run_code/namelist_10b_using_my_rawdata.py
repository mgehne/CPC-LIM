...
LIMpage_path = '/Projects/jalbers_process/CPC_LIM/yuan_ming/CPC/Images_realtime_10b_using_my_rawdata'
             ...
             'CPCtempHR':
                {'info':('./data_clim/cpcdata_hr','tavg',
                                        {'latbounds':(20,74),
                                         ...
                                         'landmask':True})},
             'T2m':
                {'info':('/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/10b_using_my_rawdata/T2m','anomaly',
                                        {'latbounds':(20,74),
                                         'lonbounds':(190,305),
                                        'datebounds':datebounds,
                                        'season0':True,
                                        ...
                                        'landmask':True})},
            'H100':
                {'info':('/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/10b_using_my_rawdata/H100','anomaly',
                                        {'level':100,
                                        'latbounds':(30,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        ...
                                        'coarsegrain':2})},
            'H500':
                {'info':('/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/10b_using_my_rawdata/H500','anomaly',
                                        {'level':500,
                                        'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        ...
                                        'coarsegrain':2})},
            'SLP':
                {'info':('/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/10b_using_my_rawdata/SLP','anomaly',
                                        {'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
                                        ...
                                        'coarsegrain':2})},
            'colIrr':
                {'info':('/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/10b_using_my_rawdata/colIrr','anomaly',
                                        {'latbounds':(-20,20),
                                         'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'season0':True,

...
use_expt_name_data = 'fixed_58-16_climo_dev_output_C0_Ctau_reforecast'
...
VAR_FILE_PREFIX = f'{expt_data_clim_path}/tmp/fullyr_JRA_58-16_fixed_climo_' # These should be mannually changed based on the training period
EOF_FILE_PREFIX = f'{expt_data_clim_path}/tmp/EOF_JRA_58-16_fixed_climo_'

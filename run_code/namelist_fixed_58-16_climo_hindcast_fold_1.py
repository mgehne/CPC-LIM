...
climoyears = (1963, 2016)# This should be the last yearly file read in, needs to manually change.
use_expt_name_data = 'fixed_58-16_climo_hindcast_fold_1'
...
VAR_FILE_PREFIX = f'{expt_data_clim_path}/tmp/fullyr_JRA_63-16_sliding_climo_' # These should be mannually changed based on the training period
EOF_FILE_PREFIX = f'{expt_data_clim_path}/tmp/EOF_JRA_63-16_sliding_climo_'

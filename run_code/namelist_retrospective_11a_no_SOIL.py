...
eof_trunc = {
            ...
            mn: {'colIrr':23,'H500':8,'SLP':20,'T2m':7,'SF750':8,'SF100':8,'SST':8} for mn in range(1,13)
            }
eof_trunc_reg = {
            # mn: {'colIrr':23,'H500':8,'SLP':20,'T2m':7,'SOIL':5,'SF750':8,'SF100':8,'SST':8,'CPCtemp':5} for mn in range(1,13)
            mn: {'colIrr':23,'H500':8,'SLP':20,'T2m':7,'SF750':8,'SF100':8,'SST':8,'CPCtemp':5} for mn in range(1,13)
            }

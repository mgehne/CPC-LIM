...
RT_VARS = { 
            'SOIL':  {'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/SOIL_All.nc',
					'varname':'anomaly'},
			'SF100': {'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/SF100_All.nc',
					'varname':'anomaly'},
			'SF750': {'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/SF750_All.nc',
					'varname':'anomaly'},
			'H500':  {'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/H500_All.nc',
					'varname':'anomaly'},
			'SLP':   {'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/SLP_All.nc',
					'varname':'anomaly'},
			'T2m':   {'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/T2m_All.nc',
					'varname':'anomaly'},
			'colIrr':{'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/colIrr_All.nc',
					'varname':'anomaly'},
     		# 'SST':   {'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/SST_All.nc',
			# 		'varname':'anomaly'}
     }
...
eof_trunc = {
            ...
            mn: {'colIrr':23,'H500':8,'SLP':20,'T2m':7,'SOIL':5,'SF750':8,'SF100':8} for mn in range(1,13)
            }
eof_trunc_reg = {
            # mn: {'colIrr':23,'H500':8,'SLP':20,'T2m':7,'SOIL':5,'SF750':8,'SF100':8,'SST':8,'CPCtemp':5} for mn in range(1,13)
            mn: {'colIrr':23,'H500':8,'SLP':20,'T2m':7,'SOIL':5,'SF750':8,'SF100':8,'CPCtemp':5} for mn in range(1,13)
            }

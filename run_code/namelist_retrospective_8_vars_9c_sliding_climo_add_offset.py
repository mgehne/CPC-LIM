...
VAR_FILE_PREFIX = '/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/9c_sliding_climo_add_offset/data_clim/tmp/fullyr_JRA_58-16_sliding_climo_add_offset'
EOF_FILE_PREFIX = '/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/9c_sliding_climo_add_offset/data_clim/tmp/EOF_JRA_58-16_sliding_climo_add_offset'
...
use_vars = {
            ...
            'SST':
                {'info':('/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/9c_sliding_climo_add_offset/SST','anomaly',
                                        {'latbounds':(-14,14),
                                         'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
                                        ...
                                        'oceanmask':True})},
            'SF750':
                {'info':('/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/9c_sliding_climo_add_offset/SF750','anomaly',
                                        {'level':750,
                                        'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
            ...
            'SF100':
                {'info':('/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/9c_sliding_climo_add_offset/SF100','anomaly',
                                        {'level':100,
                                        'latbounds':(30,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
            ...
            'T2m':
                {'info':('/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/9c_sliding_climo_add_offset/T2m','anomaly',
                                        {'latbounds':(20,74),
                                         'lonbounds':(190,305),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
                                        ...
                                        'landmask':True})},
            'SLP':
                {'info':('/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/9c_sliding_climo_add_offset/SLP','anomaly',
                                        {'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
            ...
            'H500':
                {'info':('/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/9c_sliding_climo_add_offset/H500','anomaly',
                                        {'level':500,
                                        'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
            ...
            'colIrr':
                {'info':('/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/9c_sliding_climo_add_offset/colIrr','anomaly',
                                        {'latbounds':(-14,14),
                                         'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
            ...
            'SOIL':
                {'info':('/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/9c_sliding_climo_add_offset/SOIL','anomaly',
                                        {'latbounds':(20,74),
                                         'lonbounds':(190,305),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,

...
expt_name = '9e_sliding_climo_no_double_running_mean_add_offset_simple_map'
...
RT_VARS = { 'SOIL':  {'filename':f'/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/{expt_name}/data_retrospective/SOIL_All.nc',
					'varname':'anomaly'},

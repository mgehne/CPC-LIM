...
climoyears = (1985,2014)

# Variable and EOF object file prefix
#VAR_FILE_PREFIX = 'data_clim/fullyr_JRA_79-17_'
VAR_FILE_PREFIX = 'data_clim/tmp/fullyr_JRA_58-14_climo_85-14'
EOF_FILE_PREFIX = 'data_clim/tmp/EOF_JRA_58-14_climo_85-14'
...
use_vars = {
            ...
            'SST':
                {'info':('/scratch/ycheng/JRA/Data/85-14_climo/SST','anomaly',
                                        {'latbounds':(-14,14),
                                         'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
                                        ...
                                        'oceanmask':True})},
            'SF750':
                {'info':('/scratch/ycheng/JRA/Data/85-14_climo/SF750','anomaly',
                                        {'level':750,
                                        'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        ...
                                        'season0':False})},
            'SF100':
                {'info':('/scratch/ycheng/JRA/Data/85-14_climo/SF100','anomaly',
                                        {'level':100,
                                        'latbounds':(30,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        ...
                                        'season0':False})},
            'T2m':
                {'info':('/scratch/ycheng/JRA/Data/85-14_climo/T2m','anomaly',
                                        {'latbounds':(20,74),
                                         'lonbounds':(190,305),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
                                        ...
                                        'landmask':True})},
            'SLP':
                {'info':('/scratch/ycheng/JRA/Data/85-14_climo/SLP','anomaly',
                                        {'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
                                        ...
                                        'season0':False})},
            'H500':
                {'info':('/scratch/ycheng/JRA/Data/85-14_climo/H500','anomaly',
                                        {'level':500,
                                        'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        ...
                                        'season0':False})},
            'colIrr':
                {'info':('/scratch/ycheng/JRA/Data/85-14_climo/colIrr','anomaly',
                                        {'latbounds':(-14,14),
                                         'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
                                        ...
                                        'season0':False})},
            'SOIL':
                {'info':('/scratch/ycheng/JRA/Data/85-14_climo/SOIL','anomaly',
                                        {'latbounds':(20,74),
                                         'lonbounds':(190,305),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,

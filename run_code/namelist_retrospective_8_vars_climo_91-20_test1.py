...
EOF_FILE_PREFIX = 'data_clim/tmp/EOF_JRA_58-14_climo_91-20'
...
use_vars = {
            ...
            'SST':
                {'info':('/scratch/ycheng/JRA/Data/91-20_climo_test_interp/SST','anomaly',
                                        {'latbounds':(-14,14),
                                         'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
                                        ...
                                        'oceanmask':True})},
            'SF750':
                {'info':('/scratch/ycheng/JRA/Data/91-20_climo_test_interp/SF750','anomaly',
                                        {'level':750,
                                        'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        ...
                                        'season0':False})},
            'SF100':
                {'info':('/scratch/ycheng/JRA/Data/91-20_climo_test_interp/SF100','anomaly',
                                        {'level':100,
                                        'latbounds':(30,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        ...
                                        'season0':False})},
            'T2m':
                {'info':('/scratch/ycheng/JRA/Data/91-20_climo_test_interp/T2m','anomaly',
                                        {'latbounds':(20,74),
                                         'lonbounds':(190,305),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
                                        ...
                                        'landmask':True})},
            'SLP':
                {'info':('/scratch/ycheng/JRA/Data/91-20_climo_test_interp/SLP','anomaly',
                                        {'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
                                        ...
                                        'season0':False})},
            'H500':
                {'info':('/scratch/ycheng/JRA/Data/91-20_climo_test_interp/H500','anomaly',
                                        {'level':500,
                                        'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        ...
                                        'season0':False})},
            'colIrr':
                {'info':('/scratch/ycheng/JRA/Data/91-20_climo_test_interp/colIrr','anomaly',
                                        {'latbounds':(-14,14),
                                         'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
                                        ...
                                        'season0':False})},
            'SOIL':
                {'info':('/scratch/ycheng/JRA/Data/91-20_climo_test_interp/SOIL','anomaly',
                                        {'latbounds':(20,74),
                                         'lonbounds':(190,305),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,

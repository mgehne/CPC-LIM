...
RT_VARS = { 'SOIL':{'filename':'/scratch/ycheng/JRA/Data/data_retrospective/test/landAll.nc',
					'varname':'ussl'},
			'SF100':{'filename':'/scratch/ycheng/JRA/Data/data_retrospective/test/sfAll.nc',
					'varname':'strf','level':100,'levname':'isobaricInhPa'},
			'SF750':{'filename':'/scratch/ycheng/JRA/Data/data_retrospective/test/sfAll.nc',
					'varname':'strf','level':750,'levname':'isobaricInhPa'},
			'H500':{'filename':'/scratch/ycheng/JRA/Data/data_retrospective/test/hgtAll.nc',
					'varname':'gh','level':500,'levname':'isobaricInhPa'},
			'SLP':{'filename':'/scratch/ycheng/JRA/Data/data_retrospective/test/surfAll.nc',
					'varname':'msl'},
			'T2m':{'filename':'/scratch/ycheng/JRA/Data/data_retrospective/test/surfAll.nc',
					'varname':'t2m'},
			'colIrr':{'filename':'/scratch/ycheng/JRA/Data/data_retrospective/test/phy2mAll.nc',
					'varname':'colIrr'},
     		'SST':{'filename':'/scratch/ycheng/JRA/Data/data_retrospective/test/sstAll.nc',
					'varname':'btmp'}
     }
...
use_vars = {
            ...
            'SST':
                {'info':('/scratch/ycheng/JRA/Data/5b_climo-95-14_EOF_58-14/SST','anomaly',
                                        {'latbounds':(-14,14),
                                         'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
                                        ...
                                        'oceanmask':True})},
            'SF750':
                {'info':('/scratch/ycheng/JRA/Data/5b_climo-95-14_EOF_58-14/SF750','anomaly',
                                        {'level':750,
                                        'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
            ...
            'SF100':
                {'info':('/scratch/ycheng/JRA/Data/5b_climo-95-14_EOF_58-14/SF100','anomaly',
                                        {'level':100,
                                        'latbounds':(30,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
            ...
            'T2m':
                {'info':('/scratch/ycheng/JRA/Data/5b_climo-95-14_EOF_58-14/T2m','anomaly',
                                        {'latbounds':(20,74),
                                         'lonbounds':(190,305),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
                                        ...
                                        'landmask':True})},
            'SLP':
                {'info':('/scratch/ycheng/JRA/Data/5b_climo-95-14_EOF_58-14/SLP','anomaly',
                                        {'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
            ...
            'H500':
                {'info':('/scratch/ycheng/JRA/Data/5b_climo-95-14_EOF_58-14/H500','anomaly',
                                        {'level':500,
                                        'latbounds':(20,90),
                                        'lonbounds':(0,360),
                                        'datebounds':datebounds,
            ...
            'colIrr':
                {'info':('/scratch/ycheng/JRA/Data/5b_climo-95-14_EOF_58-14/colIrr','anomaly',
                                        {'latbounds':(-14,14),
                                         'lonbounds':(0,360),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,
            ...
            'SOIL':
                {'info':('/scratch/ycheng/JRA/Data/5b_climo-95-14_EOF_58-14/SOIL','anomaly',
                                        {'latbounds':(20,74),
                                         'lonbounds':(190,305),
                                        'datebounds':datebounds,
                                        'climoyears':climoyears,

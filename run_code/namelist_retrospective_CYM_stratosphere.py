...
RT_VARS = {
			'H500':{'filename':'data_retrospective/hgtAll.nc',
                    'varname':'gh','level':[500],'levname':'isobaricInhPa'},
            # 'H10':{'filename':'data_retrospective/hgtAll.nc',
			# 		'varname':'gh','level':[10],'levname':'isobaricInhPa'},
            # 'H100':{'filename':'data_retrospective/hgtAll.nc',
            #         'varname':'gh','level':[100],'levname':'isobaricInhPa'},
            'H100+H10':{'filename':'data_retrospective/hgtAll.nc',
					'varname':'gh','level':[100,10],'levname':'isobaricInhPa'},
            # 'H100':{'filename':'data_retrospective/hgtAll.nc',
			# 		'varname':'gh','level':[100],'levname':'isobaricInhPa'},
            'SLP':{'filename':'data_retrospective/surfAll.nc',
					'varname':'msl'},
...
use_vars = {
            ...
            'H10':
                {'info':('./rawdata/H10','anomaly',
                                        ...
                                        'coarsegrain':5})},
            # 'H100+H10':
            #     {'info':('./rawdata/H100+H10','anomaly',
            #                             {'level':100,
            #                             'latbounds':(-34,90),# H100:-34-26; H10: 30-90
            #                             'lonbounds':(0,360),
            #                             'datebounds':datebounds,
            #                             'climoyears':climoyears,
            #                             'time_window':time_window,
...
eof_trunc = {
            mn: {'colIrr':23,'H500':14,('H100','H10'):12,'SLP':23,'T2m':5} for mn in range(1,13)
            }
eof_trunc_reg = {
            mn: {'colIrr':23,'H500':14,('H100','H10'):12,'SLP':23,'T2m':5,'CPCtemp':5} for mn in range(1,13)
            } 

# eof_trunc = {
#             mn: {'H500':14,('H100','H10'):12} for mn in range(1,13)
#             }
# eof_trunc_reg = {
#             mn: {'H500':14,('H100','H10'):12} for mn in range(1,13)
#             }            
...
# CYM:
# eof_trunc = {
#             mn: {'H500':14,('H100','H10'):12} for mn in range(1,2)
#             }
# eof_trunc_reg = {
#             mn: {'H500':14,('H100','H10'):12} for mn in range(1,2)
#             }    

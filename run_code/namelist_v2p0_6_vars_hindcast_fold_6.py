...
use_expt_name_data = 'v2p0_6_vars_hindcast_fold_6'
...
VAR_FILE_PREFIX = f'{expt_data_clim_path}/tmp/fullyr_JRA_58-86_93-16_sliding_climo_' # These should be mannually changed based on the training period
EOF_FILE_PREFIX = f'{expt_data_clim_path}/tmp/EOF_JRA_58-86_93-16_sliding_climo_'

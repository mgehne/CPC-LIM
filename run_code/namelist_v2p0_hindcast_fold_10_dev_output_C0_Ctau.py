...
climoyears = (1990,2009)# This should be the last yearly file read in, needs to manually change.
use_expt_name_data = 'v2p0_hindcast_fold_10'
...
VAR_FILE_PREFIX = f'{expt_data_clim_path}/tmp/fullyr_JRA_58-10_sliding_climo_' # These should be mannually changed based on the training period
EOF_FILE_PREFIX = f'{expt_data_clim_path}/tmp/EOF_JRA_58-10_sliding_climo_'
...
RT_VARS = { 
			...
			'SF100': {'filename':f'{retrospective_data_path}/{use_expt_name_data}_dev_output_C0_Ctau/data_retrospective/SF100_All.nc',
					'varname':'anomaly'},
			'SF750': {'filename':f'{retrospective_data_path}/{use_expt_name_data}_dev_output_C0_Ctau/data_retrospective/SF750_All.nc',
					'varname':'anomaly'},		
			'H500':  {'filename':f'{retrospective_data_path}/{use_expt_name_data}_dev_output_C0_Ctau/data_retrospective/H500_All.nc',
					'varname':'anomaly'},
			'SLP':   {'filename':f'{retrospective_data_path}/{use_expt_name_data}_dev_output_C0_Ctau/data_retrospective/SLP_All.nc',
					'varname':'anomaly'},
			'T2m':   {'filename':f'{retrospective_data_path}/{use_expt_name_data}_dev_output_C0_Ctau/data_retrospective/T2m_All.nc',
					'varname':'anomaly'},
			'colIrr':{'filename':f'{retrospective_data_path}/{use_expt_name_data}_dev_output_C0_Ctau/data_retrospective/colIrr_All.nc',
					'varname':'anomaly'},
   			'SOIL'  :{'filename':f'{retrospective_data_path}/{use_expt_name_data}_dev_output_C0_Ctau/data_retrospective/SOIL_All.nc',
					'varname':'anomaly'},
			'SST'   :{'filename':f'{retrospective_data_path}/{use_expt_name_data}_dev_output_C0_Ctau/data_retrospective/SST_All.nc',
					'varname':'anomaly'},

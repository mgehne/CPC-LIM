...
LIMpage_path = f'/scratch/ycheng/CPC/Images_retrospective_8_vars_climo_58-14'
...
T_START = dt(2006,1,1) #dt(YEAR,MONTH,1) 
# T_START = dt(2018,12,31) #dt(YEAR,MONTH,1)
T_END = dt(2008,12,31) #dt(YEAR,MONTH,LASTDAY)
...
LIMdriver = driver.Driver(f'namelist_retrospective_8_vars_climo_58-14.py')

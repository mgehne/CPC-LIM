...
LIMpage_path = f'/scratch/ycheng/CPC/Images_retrospective_8_vars_5b_climo_95-14_EOF_58-14'
...
LIMdriver = driver.Driver(f'namelist_retrospective_8_vars_5b_climo_95-14_EOF_58-14.py')

...
LIMpage_path = f'/Projects/jalbers_process/CPC_LIM/yuan_ming/CPC/Images_retrospective_8_vars_9b_sliding_climo_no_double_running_mean'
...
LIMdriver = driver.Driver(f'namelist_retrospective_8_vars_9b_sliding_climo_no_double_running_mean.py')

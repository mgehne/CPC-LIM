...
LIMpage_path = f'/Projects/jalbers_process/CPC_LIM/yuan_ming/CPC/Images_retrospective_8_vars_9c_sliding_climo_add_offset'
...
LIMdriver = driver.Driver(f'namelist_retrospective_8_vars_9c_sliding_climo_add_offset.py')
...
if pc_convert is None:
    ...
    climfilebase = 'data_clim/CPC.2p0'# current LIMs are all 2-deg
...
for T_INIT in hindcastdays:
    ...
    if T_INIT<dt(2021,5,29):
        ...
        climoffsetfile = climfilebase+'.1981-2010.CYM.nc'
    else:
        # climoffsetfile = climfilebase+'.1991-2020.nc'  
        climoffsetfile = climfilebase+'.1991-2020.CYM.nc'  
    print(climoffsetfile)      
    LIMdriver.save_netcdf_files(varname=Tvar,t_init=T_INIT,lead_times=(21,28),save_to_path=FCSTDIR,add_offset=climoffsetfile,add_offset_sliding_climo=True)

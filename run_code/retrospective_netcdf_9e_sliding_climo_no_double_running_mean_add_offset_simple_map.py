...
LIMpage_path = f'/Projects/jalbers_process/CPC_LIM/yuan_ming/CPC/Images_retrospective_8_vars_{expt_name}'
...
for T_INIT in hindcastdays:
    ...
    if T_INIT<dt(2021,5,29):
        ...
        climoffsetfile = '/Projects/jalbers_process/CPC_LIM/yuan_ming/Data/offline_climatology/2p0.1991-2020/data_clim/2p0.1991-2020_T2m.nc'
    ...
    LIMdriver.save_netcdf_files(varname=Tvar,t_init=T_INIT,lead_times=(21,28),save_to_path=f'{FCSTDIR}/offset',add_offset=climoffsetfile,add_offset_sliding_climo=True,append_name=var_name_append)
    ...
    def make_maps(LT):
        ...
        LIMdriver.plot_map(varname=Tvar,t_init=T_INIT,lead_times=LT,fullVariance=True ,pc_convert=pc_convert,  add_offset=climoffsetfile,add_offset_sliding_climo=True,gridded=True,\

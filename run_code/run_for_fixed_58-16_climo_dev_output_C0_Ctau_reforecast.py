...
####################################################################################
### BEGIN USER INPUT ###
expt_name = 'fixed_58-16_climo_dev_output_C0_Ctau_reforecast'
LIMpage_path = f'/Projects/jalbers_process/CPC_LIM/yuan_ming/CPC/Images_{expt_name}_dev_output_C0_Ctau'
...
for T_INIT in hindcastdays:
    ...
    try:
        ...
        LIMdriver.run_forecast_blend(t_init=T_INIT,lead_times=(21,28),fullVariance=fullVariance,\
            pc_convert=pc_convert,save_netcdf_path=f'{LIMpage_path}/model') # this directory is used to pass the directory to save model 
    except:
    ...
    def make_maps(LT):
        ...
        LIMdriver.plot_map(varname='H500',t_init=T_INIT,lead_times=LT,fullVariance=fullVariance,                     add_offset=None,add_offset_sliding_climo=False,gridded=True,\
    ...
    # LIMdriver.save_netcdf_files(varname='T2m'   ,t_init=T_INIT,lead_times=(21,28),save_to_path=f'{FCSTDIR}/T2m',      add_offset=f'{climoffsetfile}_T2m.nc',add_offset_sliding_climo=False)
    # LIMdriver.save_netcdf_files(varname='H500'  ,t_init=T_INIT,lead_times=(21,28),save_to_path=f'{FCSTDIR}/H500',     add_offset=f'{climoffsetfile}_H500.nc',add_offset_sliding_climo=False)

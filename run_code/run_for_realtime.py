...
### BEGIN USER INPUT ###
expt_name = 'realtime'
LIMpage_path = '/Projects/jalbers_process/CPC_LIM/yuan_ming/CPC/JRA-55-zero-out-soil'  # example: /Projects/LIM_v2.0/CPC-LIM-realtime/Images
...
dataGetter.download(days = [t0+timedelta(days=i-61) for i in range(61)])

...
LIMpage_path = '/Projects/jalbers_process/CPC_LIM/yuan_ming/CPC/Images_realtime_10a_using_Sam_rawdata/retrospective'
...
print('\nInitializing...')
LIMdriver = driver.Driver('namelist_10a_using_Sam_rawdata.py')
...
for T_INIT in FORECASTDAYS:
    ...
    os.system(f'mkdir {FCSTDIR}/no_offset/')
    ...
    try:
        ...
        # retrospective
        LIMdriver.run_forecast_blend(t_init=T_INIT,lead_times=(21,28,21+dayoffset,28+dayoffset),fullVariance=True,pc_convert=pc_convert) 
    except:
    ...
    # ])
    mapLTs = set([(21,28)])# for retrospective
    ...
    try:
        ...
        # LIMdriver.save_netcdf_files(varname=Tvar,t_init=T_INIT,lead_times=(0,14,21,28),save_to_path=f'{FCSTDIR}/no_offset/'                                                    )
        ...
        LIMdriver.save_netcdf_files(varname=Tvar,t_init=T_INIT,lead_times=(21,28),save_to_path=FCSTDIR,add_offset='data_clim/CPC.1991-2020.nc',append_name=var_name_append)
        LIMdriver.save_netcdf_files(varname=Tvar,t_init=T_INIT,lead_times=(21,28),save_to_path=f'{FCSTDIR}/no_offset/'                                                    )
        LIMdriver.save_netcdf_files(varname='SLP',t_init=T_INIT,lead_times=(21,28),save_to_path=FCSTDIR,add_offset='data_clim/SLP.JRA.1991-2020.nc',append_name=var_name_append)
        LIMdriver.save_netcdf_files(varname='H500',t_init=T_INIT,lead_times=(21,28),save_to_path=FCSTDIR,add_offset='data_clim/H500.JRA.1991-2020.nc',append_name=var_name_append)
        LIMdriver.save_netcdf_files(varname='colIrr',t_init=T_INIT,lead_times=(21,28),save_to_path=FCSTDIR,add_offset='data_clim/colIrr.JRA.1991-2020.nc',append_name=var_name_append)
        ...
        # LIMdriver.save_netcdf_files(varname=Tvar,t_init=T_INIT,lead_times=(0+dayoffset,14+dayoffset,21+dayoffset,28+dayoffset),save_to_path=f'{FCSTDIR}/no_offset'                                                     )

...
####################################################################################
### BEGIN USER INPUT ###
LIMpage_path = '/Projects/jalbers_process/CPC_LIM/yuan_ming/CPC/Images_realtime_10b2_using_my_rawdata'
...
print('\nInitializing...')
LIMdriver = driver.Driver('namelist_10b2_using_my_rawdata.py')

...
####################################################################################
### BEGIN USER INPUT ###
LIMpage_path = '/Projects/jalbers_process/CPC_LIM/yuan_ming/CPC/Images_realtime_10b3_using_my_rawdata'
...
FORECASTDAYS = [t0+timedelta(days=i-12) for i in range(12)]
print(FORECASTDAYS)
...
print('\nInitializing...')
LIMdriver = driver.Driver('namelist_10b3_using_my_rawdata.py')

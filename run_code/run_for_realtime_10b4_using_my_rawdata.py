...
####################################################################################
### BEGIN USER INPUT ###
LIMpage_path = '/Projects/jalbers_process/CPC_LIM/yuan_ming/CPC/Images_realtime_10b4_using_my_rawdata'
...
print('\nInitializing...')
LIMdriver = driver.Driver('namelist_10b4_using_my_rawdata.py')
...
for T_INIT in FORECASTDAYS:
    ...
    tclim_file = 'data_clim/CPC.5p0.1991-2020.CYM.nc' #CYM's 2-deg offset file
  ...
  #                  prop={'levels':np.linspace(-5,5,21),'interpolate':.25,'cbar_label':'$^oC$','dpi':DPI,'addtext':credit},save_to_path = FCSTDIR)
    ...
    try:
        ...
        # LIMdriver.save_netcdf_files(varname=Tvar,t_init=T_INIT,lead_times=(0,14,21,28),save_to_path=FCSTDIR,add_offset=tclim_file,append_name=var_name_append)
        ...
        # LIMdriver.save_netcdf_files(varname=Tvar,t_init=T_INIT,lead_times=(0+dayoffset,14+dayoffset,21+dayoffset,28+dayoffset),save_to_path=FCSTDIR,add_offset=tclim_file,append_name=var_name_append)

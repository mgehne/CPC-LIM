...
T_START = dt(2020,7,8) #dt(YEAR,MONTH,1)
...
def make_verif_maps(T_INIT,VERIFDIR):
    ...
    for label,lt in zip(['wk3','wk4','wk34'],[(21,),(28,),(21,28)]):
        ...
        plt.savefig(f'{VERIFDIR}/Images/T2m_lt{ltlab}_hitmiss_55_{T_INIT:%Y%m%d}.png',bbox_inches='tight',dpi=150)
...
for T_INIT_verif in VERIFDAYS:
    ...
    try:
        ...
        plt.grid()
        plt.savefig(f'{VERIFDIR}/Images/{varname}_HSS_timeseries.png',bbox_inches='tight')
        plt.close()
        ...
        plt.legend(loc='lower left',fontsize=10.5)
        plt.grid()
        plt.savefig(f'{VERIFDIR}/Images/{varname}_RPSS_timeseries.png',bbox_inches='tight')
        plt.close()

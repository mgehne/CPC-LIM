...
LIMdriver.get_eofs()
LIMdriver.prep_realtime_data(limkey=7,use_sliding_climo_realtime=True, verbose=True) 
...
for T_INIT in FORECASTDAYS:
    ...
    try:
        ...
        LIMdriver.run_forecast_blend(t_init=T_INIT,lead_times=np.arange(0,4),fullVariance=fullVariance,\
